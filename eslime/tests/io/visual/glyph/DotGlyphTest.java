 ...
 */
public class DotGlyphTest extends EslimeTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        Glyph small = new DotGlyph(Color.YELLOW, 0.1);
    ...
    public void testOverlay() throws Exception {
        ...
        File file = new File(outputPath + "dotGlyph.png");
        ImageIO.write(result, "png", file);

        assertBinaryFilesEqual("glyphs/dotGlyph.png", "dotGlyph.png");
    }
}
